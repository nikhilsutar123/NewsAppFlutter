            ...
            children: [
              ...
              BlocBuilder<SavedNewsBloc, SavedNewsState>(
                builder: (BuildContext context, state) {
                  ...
                  } else if (state.savedNews!.isEmpty){
                    return Expanded(
                      child: Center(child: Text(Constant.savedNewsEmpty,style: textThemeBlack(16),)),
                    );
                  }
                  return Expanded(
                    child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          return Padding(
                            ...
                            child: SavedNews(savedNews: state.savedNews![index],index: index,),
                          );
                        }),
                  );
                },
